...
class ServerViewModelTest: XCTestCase {
    ...
    private let testStateResponseJSON = "{\"commands\" : [{\"imageURL\" : \"https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/6sided_dice.jpg/800px-6sided_dice.jpg\", \"name\" : \"Fake dice\"}, {\"name\" : \"Test1\"}, {\"name\" : \"Test2\"}], \"name\" : \"Test server\", \"type\" : \"ServerStateResponse\"}"
